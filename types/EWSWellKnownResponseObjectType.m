...
#import "EWSWellKnownResponseObjectType.h"


@implementation EWSWellKnownResponseObjectType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSWellKnownResponseObjectType class]];
...
- (Class) handlerClass
{
    return [EWSWellKnownResponseObjectType class];
}
