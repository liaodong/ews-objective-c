...
#import "EWSReplyToItemType.h"


@implementation EWSReplyToItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSReplyToItemType class]];
...
- (Class) handlerClass
{
    return [EWSReplyToItemType class];
}
