...
@implementation EWSPostReplyItemBaseType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSPostReplyItemBaseType class]];
...
- (Class) handlerClass
{
    return [EWSPostReplyItemBaseType class];
}
