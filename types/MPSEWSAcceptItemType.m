...
@implementation MPSEWSAcceptItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSAcceptItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSAcceptItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"AcceptItemType: super=%@", [super description]];
}
