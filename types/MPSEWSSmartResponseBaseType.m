...
@implementation MPSEWSSmartResponseBaseType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSSmartResponseBaseType class]];
...
- (Class) handlerClass
{
    return [MPSEWSSmartResponseBaseType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"SmartResponseBaseType: super=%@", [super description]];
}
