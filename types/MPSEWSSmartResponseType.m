...
@implementation MPSEWSSmartResponseType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSSmartResponseType class]];
...
- (Class) handlerClass
{
    return [MPSEWSSmartResponseType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"SmartResponseType: NewBodyContent=%@ super=%@", _pNewBodyContent, [super description]];
}
