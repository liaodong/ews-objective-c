...
@implementation MPSEWSReferenceItemResponseType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSReferenceItemResponseType class]];
...
- (Class) handlerClass
{
    return [MPSEWSReferenceItemResponseType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"ReferenceItemResponseType: super=%@", [super description]];
}
