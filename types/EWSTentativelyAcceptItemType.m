...
#import "EWSTentativelyAcceptItemType.h"


@implementation EWSTentativelyAcceptItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSTentativelyAcceptItemType class]];
...
- (Class) handlerClass
{
    return [EWSTentativelyAcceptItemType class];
}
