...
@implementation EWSMeetingMessageType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSMeetingMessageType class]];
...
- (Class) handlerClass
{
    return [EWSMeetingMessageType class];
}
