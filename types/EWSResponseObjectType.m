...
@implementation EWSResponseObjectType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSResponseObjectType class]];
...
- (Class) handlerClass
{
    return [EWSResponseObjectType class];
}
