...
@implementation EWSRemoveItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSRemoveItemType class]];
...
- (Class) handlerClass
{
    return [EWSRemoveItemType class];
}
