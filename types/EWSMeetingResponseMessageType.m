...
@implementation EWSMeetingResponseMessageType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSMeetingResponseMessageType class]];
...
- (Class) handlerClass
{
    return [EWSMeetingResponseMessageType class];
}
