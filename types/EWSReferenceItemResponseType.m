...
#import "EWSReferenceItemResponseType.h"
...
@implementation EWSReferenceItemResponseType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSReferenceItemResponseType class]];
...
- (Class) handlerClass
{
    return [EWSReferenceItemResponseType class];
}
