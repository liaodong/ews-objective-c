...
#import "MPSEWSForwardItemType.h"
...
@implementation MPSEWSForwardItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSForwardItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSForwardItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"ForwardItemType: super=%@", [super description]];
}
