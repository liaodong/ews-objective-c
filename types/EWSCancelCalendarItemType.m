...
#import "EWSCancelCalendarItemType.h"


@implementation EWSCancelCalendarItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSCancelCalendarItemType class]];
...
- (Class) handlerClass
{
    return [EWSCancelCalendarItemType class];
}
