...
#import "MPSEWSMeetingResponseMessageType.h"
...
@implementation MPSEWSMeetingResponseMessageType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSMeetingResponseMessageType class]];
...
- (Class) handlerClass
{
    return [MPSEWSMeetingResponseMessageType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"MeetingResponseMessageType: super=%@", [super description]];
}
