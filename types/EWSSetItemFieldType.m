...
@implementation EWSSetItemFieldType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSSetItemFieldType class]];
...
- (Class) handlerClass
{
    return [EWSSetItemFieldType class];
}
