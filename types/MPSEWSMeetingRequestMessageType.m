...
#import "MPSEWSMeetingRequestMessageType.h"
...
#import "../types/MPSEWSMeetingRequestTypeType.h"
...
@implementation MPSEWSMeetingRequestMessageType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSMeetingRequestMessageType class]];
    ...
    [handler property      : @"meetingRequestType"
             ...
             withHandler   : [MPSEWSMeetingRequestTypeType class]];
...
+ (BOOL) isValid:(MPSEWSMeetingRequestMessageType*) val forVersion:(MPSEWSExchangeVersion) ver
{   (void) val;
    if (![MPSEWSMeetingMessageType isValid:val forVersion:ver]) return FALSE;
    if ([val meetingRequestType] && ![MPSEWSMeetingRequestTypeType isValid:[val meetingRequestType] forVersion:ver]) return FALSE;
    if ([val intendedFreeBusyStatus] && ![MPSEWSLegacyFreeBusyType isValid:[val intendedFreeBusyStatus] forVersion:ver]) return FALSE;
...
- (Class) handlerClass
{
    return [MPSEWSMeetingRequestMessageType class];
}
