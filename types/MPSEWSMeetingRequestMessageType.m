...
{   (void) val;
    ...
    if ([val meetingRequestType] && ![MPSEWSMeetingRequestTypeType isValid:[val meetingRequestType]]) return FALSE;
    if ([val intendedFreeBusyStatus] && ![MPSEWSLegacyFreeBusyType isValid:[val intendedFreeBusyStatus]]) return FALSE;
