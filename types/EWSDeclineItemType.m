...
#import "EWSDeclineItemType.h"


@implementation EWSDeclineItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSDeclineItemType class]];
...
- (Class) handlerClass
{
    return [EWSDeclineItemType class];
}
