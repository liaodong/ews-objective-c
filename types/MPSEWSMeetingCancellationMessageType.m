...
#import "MPSEWSMeetingCancellationMessageType.h"
...
@implementation MPSEWSMeetingCancellationMessageType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSMeetingCancellationMessageType class]];
...
- (Class) handlerClass
{
    return [MPSEWSMeetingCancellationMessageType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"MeetingCancellationMessageType: super=%@", [super description]];
}
