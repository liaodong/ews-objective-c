...
@implementation EWSSmartResponseType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSSmartResponseType class]];
...
- (Class) handlerClass
{
    return [EWSSmartResponseType class];
}
