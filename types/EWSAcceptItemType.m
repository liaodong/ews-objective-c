...
@implementation EWSAcceptItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSAcceptItemType class]];
...
- (Class) handlerClass
{
    return [EWSAcceptItemType class];
}
