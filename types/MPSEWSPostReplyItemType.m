...
#import "MPSEWSPostReplyItemType.h"
...
@implementation MPSEWSPostReplyItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSPostReplyItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSPostReplyItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"PostReplyItemType: NewBodyContent=%@ super=%@", _pNewBodyContent, [super description]];
}
