...
#import "MPSEWSCancelCalendarItemType.h"
...
@implementation MPSEWSCancelCalendarItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSCancelCalendarItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSCancelCalendarItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"CancelCalendarItemType: super=%@", [super description]];
}
