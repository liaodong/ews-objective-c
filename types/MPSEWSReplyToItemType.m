...
#import "MPSEWSReplyToItemType.h"
...
@implementation MPSEWSReplyToItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSReplyToItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSReplyToItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"ReplyToItemType: super=%@", [super description]];
}
