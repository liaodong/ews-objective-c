...
@implementation EWSMeetingCancellationMessageType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSMeetingCancellationMessageType class]];
...
- (Class) handlerClass
{
    return [EWSMeetingCancellationMessageType class];
}
