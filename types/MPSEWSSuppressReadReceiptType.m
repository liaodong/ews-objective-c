...
#import "MPSEWSSuppressReadReceiptType.h"
...
@implementation MPSEWSSuppressReadReceiptType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSSuppressReadReceiptType class]];
...
- (Class) handlerClass
{
    return [MPSEWSSuppressReadReceiptType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"SuppressReadReceiptType: super=%@", [super description]];
}
