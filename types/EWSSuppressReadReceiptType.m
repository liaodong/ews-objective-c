...
#import "EWSSuppressReadReceiptType.h"
...
@implementation EWSSuppressReadReceiptType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSSuppressReadReceiptType class]];
...
- (Class) handlerClass
{
    return [EWSSuppressReadReceiptType class];
}
