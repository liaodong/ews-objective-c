...
@implementation MPSEWSRemoveItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSRemoveItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSRemoveItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"RemoveItemType: super=%@", [super description]];
}
