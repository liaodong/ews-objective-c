...
@implementation MPSEWSPostReplyItemBaseType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSPostReplyItemBaseType class]];
...
- (Class) handlerClass
{
    return [MPSEWSPostReplyItemBaseType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"PostReplyItemBaseType: super=%@", [super description]];
}
