...
#import "MPSEWSTentativelyAcceptItemType.h"
...
@implementation MPSEWSTentativelyAcceptItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSTentativelyAcceptItemType class]];
...
- (Class) handlerClass
{
    return [MPSEWSTentativelyAcceptItemType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"TentativelyAcceptItemType: super=%@", [super description]];
}
