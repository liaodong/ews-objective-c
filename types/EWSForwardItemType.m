...
#import "EWSForwardItemType.h"


@implementation EWSForwardItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSForwardItemType class]];
...
- (Class) handlerClass
{
    return [EWSForwardItemType class];
}
