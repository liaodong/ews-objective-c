...
@implementation MPSEWSResponseObjectType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSResponseObjectType class]];
...
- (Class) handlerClass
{
    return [MPSEWSResponseObjectType class];
}

- (NSString*) description
{
    return [NSString stringWithFormat:@"ResponseObjectType: ObjectName=%@ super=%@", _objectName, [super description]];
}
