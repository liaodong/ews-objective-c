...
@implementation EWSSmartResponseBaseType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSSmartResponseBaseType class]];
...
- (Class) handlerClass
{
    return [EWSSmartResponseBaseType class];
}
