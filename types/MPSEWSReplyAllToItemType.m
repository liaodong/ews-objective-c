...
#import "MPSEWSReplyAllToItemType.h"
...
@implementation MPSEWSReplyAllToItemType 

+ (void) initialize
{
    MPSEWSObjectTypeHandler* handler = [[MPSEWSObjectTypeHandler alloc] initWithClass:[MPSEWSReplyAllToItemType class]];
...
+ (BOOL) isValid:(MPSEWSReplyAllToItemType*) val
{   (void) val;
...
- (Class) handlerClass
{
    return [MPSEWSReplyAllToItemType class];
}
