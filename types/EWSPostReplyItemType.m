...
#import "EWSPostReplyItemType.h"


@implementation EWSPostReplyItemType 

+ (void) initialize
{
    EWSObjectTypeHandler* handler = [[EWSObjectTypeHandler alloc] initWithClass:[EWSPostReplyItemType class]];
...
- (Class) handlerClass
{
    return [EWSPostReplyItemType class];
}
