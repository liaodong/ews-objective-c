...
@implementation EWSSubscriptionTimeoutType /* SimpleType */
...
+ (void) initialize
{
    [[[EWSSubscriptionTimeoutType alloc] init] register];
}

- (id) init
{
    self = [super initWithClass:[EWSSubscriptionTimeoutType class]];
    return self;
}
